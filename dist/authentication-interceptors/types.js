...
function oAuth2InterceptExpressMiddleware() {
    return core_1.intercept(core_1.composeInterceptors('passport-init-mw', 'passport-session-mw', 'passport-facebook', 'passport-oauth2', 'passport-google', 'passport-twitter', 'set-session-user'));
}
